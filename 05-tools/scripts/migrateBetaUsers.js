 ...
 *
 * Dry run all users:
 *   node 05-tools/scripts/migrateBetaUsers.js
 *
 * Commit all resolvable users, backing up each changed document first:
 *   GOOGLE_APPLICATION_CREDENTIALS=/path/to/service-account.json node 05-tools/scripts/migrateBetaUsers.js --commit
 *
 ...
 *   GOOGLE_APPLICATION_CREDENTIALS=/path/to/service-account.json node 05-tools/scripts/migrateBetaUsers.js --commit --drop-unresolved
 */

const admin = require('firebase-admin');
const { google } = require('googleapis');

const DEFAULT_PROJECT_ID = 'junior-ranger-map-auth';
...
function printUsage() {
    console.log(`
Usage:
  node 05-tools/scripts/migrateBetaUsers.js [options]
